...
3. Draft and revise in markdown (`report-body/`), not in `full/`.
4. Assemble:
   - `python3 scripts/assemble_report.py`
5. Export packaged output only after assembly is stable:
   - `python3 scripts/export_docx.py --assemble --reference-doc assets/reference.docx`
6. Run validation and prose pass before release.
7. Share working files and packaged output together.
