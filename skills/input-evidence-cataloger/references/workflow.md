# Input Evidence Catalog Workflow

## Purpose

This workflow turns a raw input set into a clean evidence inventory and factual notebook.
...
For each file or archive, record:
...
1. source register rows for every item
2. document map for folders and archives
...
1. inventory skeleton
2. factual bullets
3. short prose summary
4. flow pass for ordering and grouping
...
- `tracking/source-register.md` is current
- `tracking/review-notebook.md` reflects extracted facts
- `tracking/open-questions.md` captures unresolved gaps
- `inputs/processed/document-map.md` shows structure and supersession
