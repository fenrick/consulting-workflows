...
- `support logic`: the sub-points that make a pillar hold up
- `proof gap`: a missing piece of evidence or logic that blocks confidence
- `objection`: the strongest credible challenge to a claim
- `implication`: why the claim matters for the audience's decision
